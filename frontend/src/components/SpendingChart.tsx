    ...
    <div className="bg-white rounded-xl border border-gray-200 p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <button className="px-3 py-1 text-sm text-gray-600 hover:bg-gray-100 rounded-md transition-colors" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 500 }}>
            Daily
          </button>
          <button className="px-3 py-1 text-sm text-gray-600 hover:bg-gray-100 rounded-md transition-colors" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 500 }}>
            Weekly
          </button>
          <button className="px-4 py-1 text-sm bg-gray-900 text-white rounded-md" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 500 }}>
            Monthly
          </button>
        </div>
      </div>
        ...
        <div className="absolute inset-0 flex items-end justify-between gap-1">
          {chartData.map((data, index) => (
            <div key={index} className="flex-1 flex flex-col items-center group">
              ...
              <span className="text-xs text-gray-500 mt-2" style={{ fontFamily: 'Inter, sans-serif' }}>
                {data.date}
              </span>
              <div className="absolute opacity-0 group-hover:opacity-100 transition-opacity bg-gray-900 text-white text-xs rounded px-2 py-1 -top-8 whitespace-nowrap" style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 500 }}>
      ...
      <div className="flex items-center gap-4 mt-4 text-xs text-gray-600" style={{ fontFamily: 'Inter, sans-serif' }}>
