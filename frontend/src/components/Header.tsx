      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <h1 className="text-xl font-semibold text-white" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 600 }}>
              MindFi Dashboard
            </h1>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="px-4 py-2 text-sm bg-gray-700 text-gray-300 rounded-lg font-medium hover:bg-gray-600 transition-colors flex items-center gap-2 border border-gray-600"
            ...
            <button className="w-9 h-9 bg-gray-700 rounded-full flex items-center justify-center hover:bg-gray-600 transition-colors">
